<div class="modal fade" id="modal-investment" tabindex="-1" data-bs-focus="false" data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content border-0">
            <div class="modal-header bg-dark">
                <h5 class="modal-title text-white">Investment Information</h5>
            </div>
                ...
                <form id="investmentData" class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" style="text-transform: uppercase" name="share_amount" class="form-control" value="{{ $investment->share_amount }}">
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 mt-0 pt-0">
                        <table id="tableBeneficiary" class="table table-bordered border-top border-1 border-secondary" width="100%">
                            ...
                            <tbody id="beneficiaryContainer">
                                @if($investment->beneficiaries)
                                @foreach(json_decode($investment->beneficiaries, true) as $k => $v)
                                <tr>
                                    <td>
...
<script>
    ...
    submitModal = () => {
        ...
        if ($('#investmentData')[0].checkValidity() === true) {
            ...
            $.ajax({
                url: "{{ url('client/my-will/ajax/store-investment') }}",
                type: 'POST',
                data: formData,
                cache: false,
                contentType: false,
